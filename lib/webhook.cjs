  ...
  console.warn("Smart intent engine failed:", e?.message || e);
    ...
    if (selectedId) {
      ...
      if (selectedId === 'BTN_PRICE_BREAKUP') {
        ...
        if (_config.DEBUG) console.log('BREAKUP_RESULT:', breakup ? { hasExact: breakup.hasExactData, exShow: breakup.exShowroom, roadTax: breakup.roadTax, ins: breakup.insuranceAll, total: breakup.total } : null);
        if (!breakup) {
