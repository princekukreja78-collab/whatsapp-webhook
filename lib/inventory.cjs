...
router.put('/api/inventory/loan-schemes/:id', (req, res) => {
  ...
  for (const k of ['bank', 'roi', 'maxTenure', 'minDownPct', 'processingFee', 'notes', 'bulletPct', 'balloonPct', 'extensionTenure', 'surakshaPct', 'surakshaAmount', 'plans', 'balloonPreset', 'balloonCategory']) {
