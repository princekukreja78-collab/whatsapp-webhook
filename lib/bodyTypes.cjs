...
const BODY = {
  suv: ['creta', 'venue', 'exter', 'alcazar', 'tucson', 'seltos', 'sonet', 'syros', 'nexon', 'punch',
    ...
    // The luxury end of a Delhi forecourt, which the first pass missed
    'f-pace', 'e-pace', 'i-pace', 'xc60', 'xc90', 'xc40', 'x4', 'x6', 'x7',
    'gls', 'glb', 'gle coupe', 'q8', 'rover sport', 'bentayga', 'urus',
    'cayenne coupe', 'stelvio', 'gv70', 'gv80'],
